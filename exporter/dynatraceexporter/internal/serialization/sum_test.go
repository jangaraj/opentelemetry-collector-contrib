...
// 		got, err := serializeSumPoint("int_sum", "prefix", dimensions.NewNormalizedDimensionList(), pmetric.AggregationTemporalityDelta, dp)
...
// 		dp.SetTimestamp(pcommon.Timestamp(time.Date(2021, 0o7, 16, 12, 30, 0, 0, time.UTC).UnixNano()))

// 		//prev := ttlmap.New(1, 1, make(chan struct{}, 1))

// 		got, err := serializeSumPoint("double_sum", "prefix", dimensions.NewNormalizedDimensionList(dimensions.NewDimension("key", "value")), pmetric.AggregationTemporalityDelta, dp)
// 		assert.NoError(t, err)
...
// 		got, err := serializeSumPoint("int_sum", "prefix", dimensions.NewNormalizedDimensionList(dimensions.NewDimension("key", "value")), pmetric.AggregationTemporalityDelta, dp)
// 		assert.NoError(t, err)
...
// 		dp2.SetTimestamp(pcommon.Timestamp(time.Date(2021, 0o7, 16, 12, 31, 0, 0, time.UTC).UnixNano()))

// 		//prev := ttlmap.New(1, 1, make(chan struct{}, 1))

// 		got, err := serializeSumPoint("double_sum", "prefix", dimensions.NewNormalizedDimensionList(dimensions.NewDimension("key", "value")), pmetric.AggregationTemporalityCumulative, dp)
// 		assert.NoError(t, err)
// 		assert.Equal(t, "", got)

// 		got, err = serializeSumPoint("double_sum", "prefix", dimensions.NewNormalizedDimensionList(dimensions.NewDimension("key", "value")), pmetric.AggregationTemporalityCumulative, dp2)
// 		assert.NoError(t, err)
...
// 		got, err := serializeSumPoint("int_sum", "prefix", dimensions.NewNormalizedDimensionList(dimensions.NewDimension("key", "value")), pmetric.AggregationTemporalityCumulative, dp)
// 		assert.NoError(t, err)
// 		assert.Equal(t, "", got)

// 		got, err = serializeSumPoint("int_sum", "prefix", dimensions.NewNormalizedDimensionList(dimensions.NewDimension("key", "value")), pmetric.AggregationTemporalityCumulative, dp2)
// 		assert.NoError(t, err)
...
// 		dp2.SetTimestamp(pcommon.Timestamp(time.Date(2021, 0o7, 16, 12, 30, 0, 0, time.UTC).UnixNano()))

// 		dp3 := pmetric.NewNumberDataPoint()
// 		dp3.SetIntValue(10)
// 		dp3.Attributes().PutStr("group", "a")
// 		dp3.Attributes().PutStr("sort", "unstable")
// 		dp3.SetTimestamp(pcommon.Timestamp(time.Date(2021, 0o7, 16, 12, 30, 0, 0, time.UTC).UnixNano()))

// 		dp4 := pmetric.NewNumberDataPoint()
// 		dp4.SetIntValue(20)
// 		dp4.Attributes().PutStr("group", "b")
// 		dp4.Attributes().PutStr("sort", "unstable")
// 		dp4.SetTimestamp(pcommon.Timestamp(time.Date(2021, 0o7, 16, 12, 30, 0, 0, time.UTC).UnixNano()))

// 		//prev := ttlmap.New(1, 1, make(chan struct{}, 1))

// 		got, err := serializeSumPoint("int_sum", "prefix", dimensions.NewNormalizedDimensionList(dimensions.NewDimension("key", "a")), pmetric.AggregationTemporalityCumulative, dp)
// 		got2, err2 := serializeSumPoint("int_sum", "prefix", dimensions.NewNormalizedDimensionList(dimensions.NewDimension("key", "b")), pmetric.AggregationTemporalityCumulative, dp2)
// 		got3, err3 := serializeSumPoint("int_sum", "prefix", dimensions.NewNormalizedDimensionList(dimensions.NewDimension("key", "a")), pmetric.AggregationTemporalityCumulative, dp3)
// 		got4, err4 := serializeSumPoint("int_sum", "prefix", dimensions.NewNormalizedDimensionList(dimensions.NewDimension("key", "b")), pmetric.AggregationTemporalityCumulative, dp4)
...
// 		dp2 := pmetric.NewNumberDataPoint()
// 		dp2.SetIntValue(5)
// 		dp2.SetTimestamp(pcommon.Timestamp(time.Date(2021, 0o7, 16, 12, 29, 0, 0, time.UTC).UnixNano()))
...
// 		//prev := ttlmap.New(10, 10, make(chan struct{}, 1))

// 		zapCore, observedLogs := observer.New(zap.WarnLevel)
// 		logger := zap.New(zapCore)

// 		lines := serializeSum(logger, "", metric, empty, empty, []string{})
...
// 			actualLines := serializeSum(logger, "", metric, empty, empty, []string{})
...
func Test_convertTotalCounterToDelta_notMutating(t *testing.T) {
	...
	dp.CopyTo(orig)
	_, err := convertTotalCounterToDelta("m", "prefix", dimensions.NormalizedDimensionList{}, dp)
	assert.NoError(t, err)
